...
export const getServerSideProps  =  ( async () => {
    const fetch = await axios.get('https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=0bc00825346244b3a4b28c881462f279')
    // const fetch = await axios.get('API_URL_BUSINESS')
    const data: Tech = fetch.data
